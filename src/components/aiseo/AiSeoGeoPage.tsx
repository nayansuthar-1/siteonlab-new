...
export default function App() {
  ...
  return (
    <div className="theme-aiseo min-h-screen bg-slate-950 text-slate-100 font-sans relative overflow-x-hidden selection:bg-blue-500 selection:text-white">
      ...
      {/* HEADER & NAVIGATION */}
      <nav className="sticky top-0 z-40 bg-slate-950/80 backdrop-blur-md border-b border-slate-900" id="global-navigation">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            
            {/* Logo */}
            <a href="#" className="flex items-center gap-2 group">
              <div className="h-9 w-9 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 font-bold transition group-hover:border-blue-400 group-hover:bg-blue-500/20">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-mono tracking-widest uppercase text-blue-400 leading-none">
                  AI SEO & GEO Agency
                </span>
              </div>
            </a>
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#services-section" className="text-sm text-slate-400 hover:text-white transition">Services</a>
              <a href="#process-section" className="text-sm text-slate-400 hover:text-white transition">Process</a>
              <a href="#differentiators-section" className="text-sm text-slate-400 hover:text-white transition">Why Us</a>
              <a href="#case-studies-section" className="text-sm text-slate-400 hover:text-white transition">Case Studies</a>
              <a href="#faq-section" className="text-sm text-slate-400 hover:text-white transition">FAQs</a>
            </div>
            ...
            <div className="hidden md:flex items-center gap-4">
              <button 
                ...
                className="text-xs font-semibold bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg transition shadow-lg shadow-blue-500/5 cursor-pointer"
              >
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div 
              ...
              className="md:hidden border-b border-slate-900 bg-slate-950/95"
            >
              <div className="px-4 pt-2 pb-6 space-y-3">
                ...
                <div className="pt-3 border-t border-slate-900">
                  <button 
                    id="mobile-nav-blueprint-btn"
                    onClick={() => {
                      setIsMobileMenuOpen(false);
                      openBlueprintModal('Increase Search Citations');
                    }}
                    className="w-full text-center text-sm font-semibold bg-blue-600 text-white py-2.5 px-4 rounded-lg shadow"
                  >
                    Request Growth Blueprint
                  </button>
                </div>
      ...
      {/* FOOTER */}
      <footer className="bg-slate-950 border-t border-slate-900 py-12 relative" id="global-footer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            
            {/* Left logo info */}
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded bg-blue-500/10 flex items-center justify-center text-blue-400 font-bold">
                <Sparkles className="w-4 h-4" />
              </div>
              <div className="text-left">
                <span className="font-display font-bold text-sm tracking-tight text-white block">SiteOnLab</span>
                <span className="text-[9px] font-mono tracking-wider text-slate-500 uppercase">Generative Engine Optimization Systems</span>
              </div>
            </div>

            {/* Center legal stuff */}
            <div className="text-center text-xs text-slate-600 font-mono">
              &copy; 2026 SiteOnLab. All rights reserved. Managed with closed-loop pipeline metrics.
            </div>

            {/* Right link conduits */}
            <div className="flex items-center gap-4 text-xs font-mono text-slate-500">
              <span className="text-slate-600">Privacy Protocols</span>
              <span>·</span>
              <span className="text-slate-600">Terms of Search Visibility</span>
            </div>
