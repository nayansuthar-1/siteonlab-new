...
export default function App() {
  ...
  return (
    <div className="theme-marketingauto min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-blue-600 selection:text-white">
      ...
      <header className="sticky top-0 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-900/60 z-30 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-blue-600 to-blue-400 flex items-center justify-center shadow-lg shadow-blue-500/15">
              <span className="font-display font-extrabold text-white text-base tracking-tight">S</span>
            </div>
            <div>
              <span className="font-display font-bold text-lg text-white tracking-tight">SiteOn<span className="text-blue-500">Lab</span></span>
              <span className="text-[9px] font-mono text-zinc-500 block leading-none">REVOPS INTEGRITY</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-6 text-xs font-semibold text-zinc-400">
            ...
            <button onClick={() => handleScrollTo('process')} className="hover:text-white transition-colors cursor-pointer">Process</button>
            <button onClick={() => handleScrollTo('why-choose-us')} className="hover:text-white transition-colors cursor-pointer">Why Us</button>
            <button onClick={() => handleScrollTo('case-studies')} className="hover:text-white transition-colors cursor-pointer">Case Studies</button>
            <button onClick={() => handleScrollTo('faqs')} className="hover:text-white transition-colors cursor-pointer">FAQs</button>
          </nav>

          <div className="flex items-center space-x-3">
            <div className="hidden lg:flex items-center space-x-1.5 bg-zinc-950 px-2.5 py-1 rounded-full border border-zinc-900">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
              <span className="text-[10px] font-mono text-zinc-400">Ops Sync Active</span>
            </div>
            <button 
              id="nav-btn-blueprint"
              onClick={() => setIsBlueprintOpen(true)}
              className="bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs px-3.5 py-2 rounded-xl transition-colors cursor-pointer shadow-md shadow-blue-600/10"
            >
              Get Blueprint
            </button>
          </div>
      ...
      {/* FOOTER */}
      <footer className="bg-zinc-950 border-t border-zinc-900/60 py-12 text-xs text-zinc-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 rounded bg-gradient-to-tr from-blue-600 to-blue-400 flex items-center justify-center">
                <span className="font-display font-extrabold text-slate-950 text-xs tracking-tight">S</span>
              </div>
              <span className="font-display font-bold text-sm text-white tracking-tight">SiteOn<span className="text-blue-500">Lab</span></span>
            </div>
            <p className="text-[11px] leading-relaxed text-zinc-500">
              B2B Revenue Operations & Intelligent Marketing Automation architect systems for SaaS, tech, and professional enterprises.
            </p>
          </div>

          <div>
            <h4 className="text-xs font-semibold text-zinc-300 uppercase tracking-wider mb-3">Links</h4>
            <ul className="space-y-2 text-[11px]">
              <li><button onClick={() => handleScrollTo('services')} className="hover:text-white transition-colors cursor-pointer">Services & Stack</button></li>
              <li><button onClick={() => handleScrollTo('process')} className="hover:text-white transition-colors cursor-pointer">Process Sprints</button></li>
              <li><button onClick={() => handleScrollTo('why-choose-us')} className="hover:text-white transition-colors cursor-pointer">System Benefits</button></li>
              <li><button onClick={() => handleScrollTo('case-studies')} className="hover:text-white transition-colors cursor-pointer">Pipeline Case Studies</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[11px]">
              <li><button onClick={() => setIsBlueprintOpen(true)} className="hover:text-white transition-colors cursor-pointer text-blue-400">Request Blueprint Report</button></li>
              <li><button onClick={() => setIsAssessmentOpen(true)} className="hover:text-white transition-colors cursor-pointer text-blue-400">Automation Check</button></li>
              <li><button onClick={() => handleScrollTo('faqs')} className="hover:text-white transition-colors cursor-pointer">B2B Stack FAQ</button></li>
            </ul>
          </div>

          <div className="space-y-2">
            <h4 className="text-xs font-semibold text-zinc-300 uppercase tracking-wider mb-3">Contact</h4>
            <div className="flex items-center space-x-2 text-[11px]">
              <Mail className="w-3.5 h-3.5 text-zinc-500" />
              <span>ops@siteonlab.com</span>
            </div>
            <div className="flex items-center space-x-2 text-[11px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-zinc-900/60 pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] font-mono">
          <span>&copy; {new Date().getFullYear()} SiteOnLab. All rights reserved.</span>
          <div className="flex items-center space-x-4 mt-3 sm:mt-0">
            <span className="hover:text-white cursor-pointer">Privacy Strategy</span>
            <span>·</span>
            <span className="hover:text-white cursor-pointer">Terms of Stack</span>
          </div>
        </div>
      </footer>
