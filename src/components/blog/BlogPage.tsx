...
export default function App() {
  ...
  return (
    <div id="siteonlab-root" className="theme-blog min-h-screen bg-brand-bg text-slate-200 font-sans selection:bg-brand-accent selection:text-white">
      ...
      <div id="announcement-bar" className="sticky top-0 z-50 bg-brand-card border-b border-brand-border text-xs py-2.5 px-4 text-center flex flex-col sm:flex-row items-center justify-center gap-2 transition-colors duration-200">
        <span className="text-slate-300 flex items-center gap-1.5 font-medium">
          <Sparkles className="w-3.5 h-3.5 text-brand-accent shrink-0" />
          <span>Now helping B2B teams get found in Google — and cited in ChatGPT, Perplexity & AI Overviews.</span>
        </span>
        <button 
          id="btn-announcement-meeting"
          onClick={() => {
            setIsBookCallOpen(true);
            setBookingSuccess(false);
          }}
          className="bg-brand-accent hover:bg-brand-accent/90 text-white font-semibold px-3 py-0.5 rounded-full transition-all text-[11px] flex items-center gap-1 group active:scale-95"
        >
      ...
      <nav id="main-navigation" className="sticky top-[38px] sm:top-[38px] z-40 bg-brand-bg/95 backdrop-blur-md border-b border-brand-border transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            {/* Logo */}
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-tr from-brand-accent to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/10">
                <span className="font-display font-extrabold text-white text-lg tracking-wider">S</span>
              </div>
              <div>
                <span className="font-display font-bold text-lg tracking-tight text-white block">SiteOnLab</span>
                <span className="text-[10px] font-mono text-brand-accent uppercase tracking-widest block -mt-1">AI Visibility</span>
              </div>
            </div>

            {/* Desktop Navigation Links */}
            <div className="hidden md:flex items-center space-x-1">
              {["Framework", "Services", "Industries", "Case Studies", "About", "Resources"].map((item) => (
                <a
                  key={item}
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-md transition-all ${
                    activeNav === item 
                      ? "text-brand-accent bg-blue-950/40 border border-brand-accent/30" 
            ...
            <div className="hidden md:flex items-center gap-3">
              <button
                ...
                className="bg-brand-card hover:bg-[#242933] border border-brand-border text-slate-100 text-xs font-semibold px-5 py-2.5 rounded-lg transition-all flex items-center gap-2 active:scale-95"
              >
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-b border-brand-border bg-[#0F1115] px-4 pt-2 pb-6 space-y-2"
            >
              {["Framework", "Services", "Industries", "Case Studies", "About", "Resources"].map((item) => (
                <a
                  key={item}
                  id={`nav-link-mobile-${item.toLowerCase().replace(/\s+/g, '-')}`}
                  href="#"
                  onClick={(e) => {
                    e.preventDefault();
                    setActiveNav(item);
                  ...
                  className={`block px-4 py-3 text-base font-medium rounded-lg transition-all ${
                    activeNav === item 
                      ? "text-brand-accent bg-blue-950/40 border border-brand-accent/50" 
              ...
              <div className="pt-4 border-t border-brand-border space-y-3">
                <button
                  ...
                  className="w-full bg-brand-accent hover:bg-brand-accent/90 text-white text-sm font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-2"
                >
                  <span>Book a Strategy Call</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
                <button
                  id="btn-mobile-assessment"
                  onClick={() => {
                    setIsMobileMenuOpen(false);
                    setIsAssessmentOpen(true);
                    setAssessmentSuccess(false);
                  }}
                  className="w-full bg-brand-card hover:bg-[#242933] border border-brand-border text-slate-300 text-sm font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-2"
                >
                  <span>Free AI Visibility Assessment</span>
                </button>
              </div>
            </motion.div>
          )}
      ...
      {/* 9. FOOTER */}
      <footer id="global-footer" className="bg-brand-bg border-t border-brand-border pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-brand-border">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm">
              The AI-powered B2B revenue growth and AI visibility agency. Aligning enterprise brands with conversational algorithms to accelerate premium pipeline.
            </p>
            <div className="flex space-x-3">
              <a href="#" className="p-2 rounded bg-brand-card text-slate-400 hover:text-white hover:bg-[#242933] transition-colors">
          ...
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-xs font-mono font-bold uppercase tracking-widest text-white">Services & pillars</h4>
            <ul className="space-y-2.5 text-sm">
              {["Generative Engine Optimization (GEO)", "B2B Intent SEO", "RevOps Alignment", "AI Agent Integrations", "Conversational PR"].map((serv) => (
                <li key={serv}>
                  <a href="#" className="text-slate-400 hover:text-brand-accent transition-all">{serv}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs font-mono font-bold uppercase tracking-widest text-white">Industries</h4>
            <ul className="space-y-2.5 text-sm">
              {["SaaS & Cloud", "Fintech Enterprise", "Cybersecurity Software", "Industrial IoT", "Healthtech B2B"].map((ind) => (
                <li key={ind}>
                  <a href="#" className="text-slate-400 hover:text-brand-accent transition-all">{ind}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-xs font-mono font-bold uppercase tracking-widest text-white">Company & Insights</h4>
            <ul className="space-y-2.5 text-sm">
              {["Our B2B Growth Framework", "Success Case Studies", "About SiteOnLab", "Active Resources Library", "Book Discovery Strategy"].map((comp) => (
                <li key={comp}>
                  <a href="#" className="text-slate-400 hover:text-brand-accent transition-all">{comp}</a>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div>
            &copy; {new Date().getFullYear()} SiteOnLab Inc. All rights reserved. Registered AI B2B Agency.
          </div>
